...
int main(int argc, char *argv[])
{
  ...
  status=heliolinc_alg_RR(image_log, detvec, tracklets, trk2det, radhyp, earthpos, config, outclust, clust2det);
  if(status!=0) {
